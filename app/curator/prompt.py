...
NISSE_CURATOR_PROMPT = (
    ...
    "- GRANT, OR BUILD. Lacking only the means: add the name to that worker's `tool_names` and change "
    "nothing else. Different in KIND — a different way of working, a different shape of result, a "
    "different way of going wrong — give it its own worker. Topic alone does not earn a worker.\n"
