...
Замер за 30 дней на 2026-08-08: 531 прогон, $103.70. Доля — от всего счёта. Источник и методика —
`PRICING.md`; здесь только схема по тем же числам, и обновлять их надо там, а не тут.
